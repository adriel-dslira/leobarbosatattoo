<?php include_once './inc/header.php';?>
        ...
        <div class="first_call word limitator">
            <h1 class="word animate-lettersTitle word limitator">AUMENTANDO AUTO-ESTIMAS E SIGNIFICANDO MOMENTOS COM <span style="color: #F0B648; font-style: italic; font-weight: 800;" class="dynamicWord">TATUAGENS</span>.</h1>
